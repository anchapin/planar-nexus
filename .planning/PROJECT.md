...
- **Chat Interface**: Chat-style UI in deck coach section for conversational interaction
- **Natural Language Q&A**: Ask questions like "What cards should I cut?" or "What's my win condition?"
- **Context-Aware Responses**: AI analyzes current deck and provides relevant advice
- **Conversation Continuity**: Support for follow-up questions and context retention
