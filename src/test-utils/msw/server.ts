/**
 * MSW Node.js server handlers for integration tests
 * 
 * This module provides server-side handlers for testing server actions
 * and API routes in a Node.js environment (Jest).
 */
...
/**
 * Create mock Scryfall card data (Node.js version)
 */
...
/**
 * Node.js server handlers for Scryfall API
 */
export const scryfallServerHandlers = [
...
/**
 * Default handlers for Node.js environment
 */
export const serverHandlers = [...scryfallServerHandlers];

/**
 * Create and start the MSW server for Node.js
 */
...
export { http, HttpResponse, delay, setupServer };
