...
describe("archetype-detector", () => {
  ...
  describe("detectArchetype", () => {
    ...
    it("should detect Control archetype", () => {
      ...
      expect(["Draw-Go", "Control", "Stax", "Prison"]).toContain(
        result.primary,
      );
      expect(result.confidence).toBeGreaterThan(0.2);
    });
    ...
    it("should detect Midrange Pile hybrid", () => {
      ...
      expect(["Midrange Pile", "Jund-style", "Good Stuff"]).toContain(
        result.primary,
      );
    ...
    it("should detect Control-Midrange hybrid", () => {
      ...
      expect(["Control-Midrange", "Draw-Go", "Good Stuff"]).toContain(
        result.primary,
      );
      expect(result.confidence).toBeGreaterThan(0.15);
    });
  ...
  describe("hybrid archetype detection", () => {
    ...
    it("should detect hybridArchetypes for aggro-midrange hybrid", () => {
      ...
      if (result.hybridArchetypes && result.hybridArchetypes.length > 0) {
        ...
        expect(["Aggro-Midrange", "Zoo", "Good Stuff"]).toContain(
          result.primary,
        );
      }
    });
