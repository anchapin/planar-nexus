 ...
 */
export function detectTribalAffiliation(deck: DeckCard[]): {
  tribe: string | null;
  memberCount: number;
  density: number;
} {
 ...
 */
export function identifyOffTribeCards(
  deck: DeckCard[],
  tribe: string,
): string[] {
  ...
  for (const card of deck) {
    ...
    const isTribeMember = patterns.some((pattern) =>
 ...
 */
export function getTribalRecommendations(
  tribe: string,
  tribeMemberCount: number,
  offTribeCardCount: number,
): string[] {
  const recommendations: string[] = [];

  if (offTribeCardCount > 5) {
    recommendations.push(
      `Consider replacing ${Math.min(offTribeCardCount, 8)} off-tribe creatures with additional ${tribe} to strengthen your tribal synergy`,
    );
  }

  if (tribeMemberCount >= 10 && tribeMemberCount < 15) {
    recommendations.push(
      `You have a solid ${tribe} foundation. Adding 3-5 more ${tribe} creatures would maximize tribal synergy`,
    );
  }

  if (tribeMemberCount >= 15) {
    recommendations.push(
      `Excellent ${tribe} density! Focus on tribal lords and payoff cards to maximize your advantage`,
    );
  }
  ...
  switch (tribe) {
    case "elves":
      recommendations.push(
        "Consider Elvish Archdruid or Ezuri, Renegade Leader as tribal lords",
      );
      recommendations.push(
        "Craterhoof Behemoth is a powerful finisher for elf decks",
      );
      break;
    case "goblins":
      recommendations.push(
        "Consider Goblin Warchief or Muxus, Goblin Grandee as tribal lords",
      );
      recommendations.push(
        "Goblin Matron can help you find key goblins when needed",
      );
      break;
    case "zombies":
      recommendations.push(
        "Consider Cemetery Reaper or Relentless Dead for graveyard recursion",
      );
      recommendations.push(
        "Lord of the Accursed can give your zombies menace for evasion",
      );
      break;
    case "dragons":
      recommendations.push(
        "Consider Dragonlord Kolaghan or Dragonlord Ojutai as tribal lords",
      );
      recommendations.push(
        "Ensure you have enough ramp to cast your dragons on time",
      );
      break;
    case "vampires":
      recommendations.push(
        "Consider Edgar Markov or Bloodlord of Vaasgoth as tribal lords",
      );
      recommendations.push(
        "Blood Artist provides value whenever creatures die",
      );
      break;
    case "merfolk":
      recommendations.push(
        "Consider Master of the Pearl Trident or Lord of Atlantis as tribal lords",
      );
      recommendations.push(
        "Spreading Seas can give your merfolk unblockable attacks",
      );
      break;
    case "humans":
      recommendations.push(
        "Consider Thalia's Lieutenant or Kessig Malcontents as tribal payoffs",
      );
      recommendations.push(
        "Thalia, Guardian of Thraben provides tempo disruption",
      );
      break;
  }
...
export const SYNERGY_SIGNATURES: SynergySignature[] = [
  // === TRIBAL SYNERGIES (7) ===
  {
    ...
    scoreFunction: (deck) => {
      ...
      const { count: bonusCount } = countMatchingCards(deck, [
        "heritage druid",
        "wirewood",
        "ezuri",
        "craterhoof",
      ...
      return {
        ...
        score,
        cards,
        description: "Elf tribal synergy",
        category: "tribal",
      };
    },
  },
  {
    ...
    scoreFunction: (deck) => {
      ...
      return {
        ...
        score,
        cards,
        description: "Goblin tribal synergy",
        category: "tribal",
      };
    },
  },
  {
    ...
    minimumCards: 12,
    scoreFunction: (deck) => {
      const { count, cards } = countMatchingCards(deck, [
        "zombie",
        "lich",
        "skeleton",
        "undead",
      ...
      return {
        ...
        score,
        cards,
        description: "Zombie tribal with graveyard synergy",
        category: "tribal",
      };
    },
  },
  {
    ...
    scoreFunction: (deck) => {
      ...
      return {
        ...
        score,
        cards,
        description: "Dragon tribal with ramp",
        category: "tribal",
      };
    },
  },
  {
    ...
    scoreFunction: (deck) => {
      ...
      return {
        ...
        score,
        cards,
        description: "Vampire tribal with life drain",
        category: "tribal",
      };
    },
  },
  {
    ...
    scoreFunction: (deck) => {
      ...
      return {
        ...
        score,
        cards,
        description: "Merfolk tribal with islandwalk",
        category: "tribal",
        totalCount: count,
      };
    },
  },
  {
    ...
    scoreFunction: (deck) => {
      ...
      return {
        ...
        score,
        cards,
        description: "Human tribal with anthems",
        category: "tribal",
      };
    },
  },
  ...
  // === MECHANIC SYNERGIES (4) ===
  {
    ...
    scoreFunction: (deck) => {
      ...
      return {
        ...
        score,
        cards,
        description: "Flying creatures synergy",
        category: "mechanic",
      };
    },
  },
  {
    ...
    scoreFunction: (deck) => {
      ...
      return {
        ...
        score,
        cards,
        description: "Deathtouch creatures synergy",
        category: "mechanic",
      };
    },
  },
  {
    ...
    scoreFunction: (deck) => {
      ...
      return {
        ...
        score,
        cards,
        description: "Trample creatures synergy",
        category: "mechanic",
      };
    },
  },
  {
    ...
    scoreFunction: (deck) => {
      ...
      return {
        ...
        score,
        cards,
        description: "Haste creatures synergy",
        category: "mechanic",
      };
    },
  },
  ...
  // === ENGINE SYNERGIES (4) ===
  {
    ...
    scoreFunction: (deck) => {
      ...
      return {
        ...
        score,
        cards,
        description: "Card advantage engine",
        category: "engine",
      };
    },
  },
  {
    ...
    scoreFunction: (deck) => {
      ...
      return {
        ...
        score,
        cards,
        description: "Mana acceleration engine",
        category: "engine",
      };
    },
  },
  {
    ...
    scoreFunction: (deck) => {
      ...
      return {
        ...
        score,
        cards,
        description: "Comprehensive removal",
        category: "engine",
      };
    },
  },
  {
    ...
    scoreFunction: (deck) => {
      ...
      return {
        ...
        score,
        cards,
        description: "Counterspell interaction",
        category: "engine",
      };
    },
  },
  ...
  // === COMBO SYNERGIES (4) ===
  {
    ...
    scoreFunction: (deck) => {
      ...
      return {
        ...
        score,
        cards,
        description: "Reanimate creatures from graveyard",
        category: "combo",
      };
    },
  },
  {
    ...
    minimumCards: 10,
    scoreFunction: (deck) => {
      const ritualCount = countMatchingCards(deck, [
        "ritual",
        "dark ritual",
        "cabal ritual",
        "seething song",
      ...
      const cantripCount = countMatchingCards(deck, [
        "draw",
        "cantrip",
        "opt",
        "peek",
      ...
      const finisherCount = countMatchingCards(deck, [
        "storm",
        "tendrils",
        "past in flames",
        "mind desire",
      ...
      const total =
        ritualCount.count + cantripCount.count + finisherCount.count;
      const cards = [
        ...ritualCount.cards,
        ...cantripCount.cards,
        ...finisherCount.cards,
      ...
      return {
        ...
        score,
        cards,
        description: "Storm combo finish",
        category: "combo",
      };
    },
  },
  {
    ...
    scoreFunction: (deck) => {
      ...
      return {
        ...
        score,
        cards,
        description: "Token generation synergy",
        category: "combo",
      };
    },
  },
  {
    ...
    scoreFunction: (deck) => {
      ...
      return {
        ...
        score,
        cards,
        description: "Infinite combination potential",
        category: "combo",
      };
    },
  },
  ...
  // === SPECIAL SYNERGIES (4) ===
  {
    ...
    scoreFunction: (deck) => {
      const landCount = deck
        ...
        .reduce((sum, c) => sum + c.count, 0);
      const { count: bonusCount, cards } = countMatchingCards(deck, [
        "recur",
        "return",
        "fetch",
        "search",
      ...
      return {
        ...
        score,
        cards,
        description: "Land-focused strategy",
        category: "special",
      };
    },
  },
  {
    ...
    scoreFunction: (deck) => {
      ...
      return {
        ...
        score,
        cards,
        description: "Planeswalker value engine",
        category: "special",
      };
    },
  },
    ...
    try {
      ...
      if (cardCount < signature.minimumCards) {
        ...
        result.score = Math.floor(
          result.score * (cardCount / signature.minimumCards),
        );
      }
      ...
      if (signature.category === "tribal" && tribalAffiliation.tribe) {
        ...
        if (tribeKey && tribalAffiliation.tribe === tribeKey) {
          const offTribeCards = identifyOffTribeCards(
            deck,
...
export function getSynergyByName(name: string): SynergySignature | undefined {
  return SYNERGY_SIGNATURES.find(
...
export function detectMissingSynergies(
  ...
  if (archetype) {
    const archetypeMissing = getArchetypeSpecificMissingSynergies(
      deck,
      archetype,
    );
 ...
 */
function checkPartialSynergyPresence(
  deck: DeckCard[],
  synergy: { cards: string[]; minimumCards?: number },
): boolean {
 ...
 */
function getArchetypeSpecificMissingSynergies(
  deck: DeckCard[],
  archetype: string,
): MissingSynergy[] {
  const missing: MissingSynergy[] = [];
  ...
  if (archetype.toLowerCase().includes("elf")) {
    ...
    if (elves >= 10 && lords < 2) {
      missing.push({
        ...
        suggestion:
          "Elvish Archdruid, Ezuri Renegade Leader, Imperator of Pleasures",
        impact: "high",
      });
    }
  ...
  if (archetype.toLowerCase().includes("merfolk")) {
    ...
    if (merfolk >= 8 && lords < 2) {
      missing.push({
        ...
        suggestion:
          "Master of the Pearl Trident, Lord of Atlantis, Merrow Reejerey",
        impact: "high",
      });
    }
  ...
  if (archetype.toLowerCase().includes("human")) {
    ...
    if (humans >= 10 && lords < 2) {
      missing.push({
        ...
        suggestion:
          "Thalia's Lieutenant, Kessig Malcontents, Champion of the Parish",
        impact: "high",
      });
    }
    ...
    if (humans >= 10 && disruption < 3) {
      missing.push({
        ...
        suggestion:
          "Thalia, Guardian of Thraben, Meddling Mage, Leonin Arbiter",
        impact: "medium",
      });
    }
  }
  ...
  if (
    archetype.toLowerCase().includes("control") ||
    archetype.toLowerCase().includes("draw-go")
  ) {
    const counterspells = countPattern(deck, [
      "counter",
      "negate",
      "counterspell",
    ]);
    const cardDraw = countPattern(deck, [
      "draw",
      "divination",
      "brainstorm",
      "ponder",
    ]);
    const boardWipe = countPattern(deck, [
      "wrath",
      "sweep",
      "all creatures",
      "destroy all",
    ...
    if (cardDraw >= 10 && boardWipe < 3) {
      missing.push({
        ...
        missing: "Board wipes",
        description:
          "Your control deck needs board wipes to handle creature-heavy matchups.",
  ...
  if (
    archetype.toLowerCase().includes("aggro") ||
    archetype.toLowerCase().includes("burn")
  ) {
    const burnSpells = countPattern(deck, [
      "lightning bolt",
      "burn",
      "direct damage",
      "shock",
    ...
    if (creatures >= 15 && haste < 6) {
      missing.push({
        ...
        description:
          "Your aggro deck could benefit from more haste creatures for immediate impact.",
    ...
    if (burnSpells >= 8 && creatures < 12) {
      missing.push({
        ...
        description:
          "Your burn deck needs creatures that can deal damage quickly.",
        suggestion:
          "Goblin Guide, Monastery Swiftspear, Eidolon of the Raging Storm",
        impact: "medium",
      });
    }
  }
  ...
  if (
    archetype.toLowerCase().includes("combo") ||
    archetype.toLowerCase().includes("storm")
  ) {
    const comboPieces = countPattern(deck, [
      "combo",
      "infinite",
      "storm",
      "ritual",
