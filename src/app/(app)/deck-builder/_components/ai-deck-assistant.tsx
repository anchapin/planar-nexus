...
import { type ScryfallCard, type DeckCard } from "@/lib/card-database";
import {
  Card,
  CardContent,
  CardDescription,
            ...
            <div className="p-4 space-y-4">
              {suggestions.map((card) => {
                ...
                return (
                  <Card
                    key={card.id}
                    className="overflow-hidden border-primary/10 bg-card/50"
                  >
