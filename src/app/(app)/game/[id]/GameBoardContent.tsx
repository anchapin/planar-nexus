...
import { AIOpponent, type AttackDecisionData } from "@/ai/ai-opponent";
...
import { BASIC_LAND_NAMES } from "@/lib/basic-land-data";
...
export function GameBoardContent({ initialGameId }: GameBoardContentProps) {
  ...
  const gameId = initialGameId ?? searchParams.get("id") ?? "";
