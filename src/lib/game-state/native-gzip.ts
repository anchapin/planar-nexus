 ...
 * Issue #1724: moved into the engine (from src/lib/compression/) because
 * game-state serialization compression depends on it; the old path is a
 * re-export facade for src/lib/backup-compression.ts.
 *
 * ## Why native?
 *
