...
// #1718: card-data joined the family surface — it predates this suite
// (moved in #1724) and was the one types/ member with no direct test
// reference.
import * as fam11 from "../../types/card-data";
import type * as famT11 from "../../types/card-data";
...
describe("types/card-data family surface", () => {
  it("is type-only; the shim export is pinned by the compiler", () => {
