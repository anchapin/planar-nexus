...
describe('Video-Derived Fixture: commander-damage-race', () => {
  ...
  it('has valid player data', () => {
    ...
    expect(Array.isArray(commander_damage_race.gameState.battlefield_player)).toBe(true);
    expect(Array.isArray(commander_damage_race.gameState.battlefield_opponent)).toBe(true);
  });
