...
describe('Video-Derived Fixture: full-game-late-state', () => {
  it('loads game state successfully', () => {
    expect(full_game_late_state.gameState).toBeDefined();
    expect(full_game_late_state.gameState).toBeInstanceOf(Object);
  });

  it('has valid player data', () => {
    expect(full_game_late_state.gameState.player_life).toBeGreaterThan(0);
    expect(full_game_late_state.gameState.opponent_life).toBeGreaterThan(0);
    expect(Array.isArray(full_game_late_state.gameState.battlefield_player)).toBe(true);
    expect(Array.isArray(full_game_late_state.gameState.battlefield_opponent)).toBe(true);
  });
