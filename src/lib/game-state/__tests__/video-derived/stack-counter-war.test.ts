...
describe('Video-Derived Fixture: stack-counter-war', () => {
  ...
  it('has valid player data', () => {
    ...
    expect(Array.isArray(stack_counter_war.gameState.battlefield_player)).toBe(true);
    expect(Array.isArray(stack_counter_war.gameState.battlefield_opponent)).toBe(true);
  });
