...
describe('Video-Derived Fixture: life-loss-basic', () => {
  ...
  it('has valid player data', () => {
    ...
    expect(Array.isArray(life_loss_basic.gameState.battlefield_player)).toBe(true);
    expect(Array.isArray(life_loss_basic.gameState.battlefield_opponent)).toBe(true);
  });
