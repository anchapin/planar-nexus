...
describe('Video-Derived Fixture: multi-land-board', () => {
  ...
  it('has valid player data', () => {
    ...
    expect(Array.isArray(multi_land_board.gameState.battlefield_player)).toBe(true);
    expect(Array.isArray(multi_land_board.gameState.battlefield_opponent)).toBe(true);
  });
