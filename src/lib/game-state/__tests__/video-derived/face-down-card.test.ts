...
describe('Video-Derived Fixture: face-down-card', () => {
  ...
  it('has valid player data', () => {
    ...
    expect(Array.isArray(face_down_card.gameState.battlefield_player)).toBe(true);
    expect(Array.isArray(face_down_card.gameState.battlefield_opponent)).toBe(true);
  });
