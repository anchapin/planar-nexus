...
describe('Video-Derived Fixture: land-destruction', () => {
  ...
  it('has valid player data', () => {
    ...
    expect(Array.isArray(land_destruction.gameState.battlefield_player)).toBe(true);
    expect(Array.isArray(land_destruction.gameState.battlefield_opponent)).toBe(true);
  });
