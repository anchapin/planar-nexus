...
describe('Video-Derived Fixture: upkeep-trigger', () => {
  ...
  it('has valid player data', () => {
    ...
    expect(Array.isArray(upkeep_trigger.gameState.battlefield_player)).toBe(true);
    expect(Array.isArray(upkeep_trigger.gameState.battlefield_opponent)).toBe(true);
  });
