...
describe('Video-Derived Fixture: proliferate-board', () => {
  ...
  it('has valid player data', () => {
    ...
    expect(Array.isArray(proliferate_board.gameState.battlefield_player)).toBe(true);
    expect(Array.isArray(proliferate_board.gameState.battlefield_opponent)).toBe(true);
  });
