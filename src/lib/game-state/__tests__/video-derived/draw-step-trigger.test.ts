...
describe('Video-Derived Fixture: draw-step-trigger', () => {
  ...
  it('has valid player data', () => {
    ...
    expect(Array.isArray(draw_step_trigger.gameState.battlefield_player)).toBe(true);
    expect(Array.isArray(draw_step_trigger.gameState.battlefield_opponent)).toBe(true);
  });
