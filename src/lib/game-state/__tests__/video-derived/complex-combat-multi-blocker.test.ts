...
describe('Video-Derived Fixture: complex-combat-multi-blocker', () => {
  ...
  it('has valid player data', () => {
    expect(complex_combat_multi_blocker.gameState.player_life).toBeGreaterThan(0);
    expect(complex_combat_multi_blocker.gameState.opponent_life).toBeGreaterThan(0);
    expect(Array.isArray(complex_combat_multi_blocker.gameState.battlefield_player)).toBe(true);
    expect(Array.isArray(complex_combat_multi_blocker.gameState.battlefield_opponent)).toBe(true);
  });

  it('has valid turn structure', () => {
    expect(typeof complex_combat_multi_blocker.gameState.turn_number).toBe('number');
    expect(complex_combat_multi_blocker.gameState.turn_number).toBeGreaterThan(0);
