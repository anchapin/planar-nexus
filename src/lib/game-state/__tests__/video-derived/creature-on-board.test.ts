...
describe('Video-Derived Fixture: creature-on-board', () => {
  ...
  it('has valid player data', () => {
    ...
    expect(Array.isArray(creature_on_board.gameState.battlefield_player)).toBe(true);
    expect(Array.isArray(creature_on_board.gameState.battlefield_opponent)).toBe(true);
  });
