...
describe('Video-Derived Fixture: planeswalker-in-play', () => {
  ...
  it('has valid player data', () => {
    ...
    expect(Array.isArray(planeswalker_in_play.gameState.battlefield_player)).toBe(true);
    expect(Array.isArray(planeswalker_in_play.gameState.battlefield_opponent)).toBe(true);
  });
