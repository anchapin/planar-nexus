...
describe('Video-Derived Fixture: low-life-state', () => {
  ...
  it('has valid player data', () => {
    ...
    expect(Array.isArray(low_life_state.gameState.battlefield_player)).toBe(true);
    expect(Array.isArray(low_life_state.gameState.battlefield_opponent)).toBe(true);
  });
