...
describe('Video-Derived Fixture: reanimator-target', () => {
  ...
  it('has valid player data', () => {
    ...
    expect(Array.isArray(reanimator_target.gameState.battlefield_player)).toBe(true);
    expect(Array.isArray(reanimator_target.gameState.battlefield_opponent)).toBe(true);
  });
