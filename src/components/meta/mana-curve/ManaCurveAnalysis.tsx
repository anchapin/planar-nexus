    ...
    <div className="space-y-6">
        ...
        <Card>
          <CardContent className="pt-4">
            ...
            <div className="text-2xl font-bold">
              {deckCurve.averageCMC.toFixed(1)}
            </div>
          </CardContent>
        </Card>
        <Card>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Your deck's spell distribution compared to recommended{" "}
            {strategyName} curve
          </CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Recommended land count for your deck
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          <Separator />
          <p className="text-sm text-muted-foreground">{landRec.reasoning}</p>
      ...
      {recommendations.length > 0 && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Specific changes to improve your mana curve
            </CardDescription>
          </CardHeader>
          <CardContent>
