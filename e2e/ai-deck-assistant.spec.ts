...
test.describe('AI Deck Assistant', () => {
  ...
  test('should display initial state of AI Assistant', async ({ page }) => {
    ...
    const emptyState = page.locator('text=Add cards to your deck to get AI suggestions');
    await expect(emptyState).toBeVisible();
  });

  test('should provide synergistic suggestions after adding cards', async ({ page }) => {
    // 1. Search for a card
  ...
  test('should provide a streamed AI explanation', async ({ page }) => {
  ...
  test('should show synergy badges on card search results', async ({ page }) => {
